...
const ChatContainer = ({selectedUser, setSelectedUser}) => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messagesDummyData.map((msg, index)=>(
          ...
          senderId !== '680f50aaf10f3cd28382ecf2' && 'flex-row-reverse' }`}>
            {msg.image ? (
            ...
            <div className="text-center text-xs">
              <img src={msg.senderId === '680f50aaf10f3cd28382ecf2' ? assets.avatar_icon : 
   ...
   <div className='flex flex-col items-center justify-center gap-2 max-md:hidden'>
    ...
    <p className='text-white text-2xl font-semibold'>Chat anytime, anywhere</p>
